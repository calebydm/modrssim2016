...
void CAboutDlg::OnBnClickedCheckupdates()
{
   CUpdateCheck checker;
		//  Revised three lines below on 2015-08-05 & 2015-11-22 by DL to use www.douglyons.us for source of Version compare
		//checker.Check(CString ("http://sites.google.com/site/plcsimulator/Home/versioninfo.txt?attredirects=0&d=1"));
        //checker.Check(CString ("http://iweb.dl.sourceforge.net/project/modrssim2/README.txt"));
		checker.Check(CString ("http://www.douglyons.us"));
